...
class BayesianCM(torch.nn.Module):
    """
    -- Bayesian Committee Machine --
    --
    -- Adaptation to Pytorch + GP framework
    -- V. Tresp "A Bayesian Committee Machine"
    -- Reference: https://www.dbs.ifi.lmu.de/~tresp/papers/bcm6.pdf
    """

    def __init__(self, models, input_dim=1.0):
        super(BayesianCM, self).__init__()
